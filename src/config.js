...
module.exports = {
  ...
  maxWaitingStarts: parseInt(process.env.MAX_WAITING_STARTS || '30', 10),
  ...
  staleQrMs: parseInt(process.env.STALE_QR_MS || '60000', 10),
  // Never-connected reconnect loops stuck longer than this → hard reset
  stuckReconnectMs: parseInt(process.env.STUCK_RECONNECT_MS || '45000', 10),
  // Optional proxy list for routing Baileys sockets (comma-separated SOCKS5 or HTTP proxies)
